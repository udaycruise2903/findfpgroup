...
/* package findfpgroup-0.1.0.0 */
#ifndef VERSION_findfpgroup
#define VERSION_findfpgroup "0.1.0.0"
#endif /* VERSION_findfpgroup */
#ifndef MIN_VERSION_findfpgroup
#define MIN_VERSION_findfpgroup(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_findfpgroup */
...
#define CURRENT_COMPONENT_ID "findfpgroup-0.1.0.0-2XH2G8AdPPO36uhgahWsD3-findfpgroup"
