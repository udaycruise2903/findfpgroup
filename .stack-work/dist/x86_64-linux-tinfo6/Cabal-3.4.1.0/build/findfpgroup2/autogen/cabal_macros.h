...
/* package findfpgroup2-0.1.0.0 */
#ifndef VERSION_findfpgroup2
#define VERSION_findfpgroup2 "0.1.0.0"
#endif /* VERSION_findfpgroup2 */
#ifndef MIN_VERSION_findfpgroup2
#define MIN_VERSION_findfpgroup2(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_findfpgroup2 */
...
#define CURRENT_COMPONENT_ID "findfpgroup2-0.1.0.0-HcraWYdgzJeoHEyTwfbCf-findfpgroup2"
